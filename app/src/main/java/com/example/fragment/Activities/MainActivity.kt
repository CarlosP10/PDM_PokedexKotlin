...
import com.example.fragment.Fragments.PokemonDetailFragment
import com.example.fragment.Fragments.PokemonListFragment
...
class MainActivity : AppCompatActivity(), PokemonListFragment.ListenerTools{

    private lateinit var mainFragment : PokemonListFragment
    private lateinit var mainContentFragment: PokemonDetailFragment
    ...
    fun initMainFragment(){
        mainFragment = PokemonListFragment.newInstance(pokemonList)

        val resource = if(resources.configuration.orientation == Configuration.ORIENTATION_PORTRAIT)
            R.id.main_fragment
        else {
            mainContentFragment = PokemonDetailFragment.newInstance(Pokemon())
